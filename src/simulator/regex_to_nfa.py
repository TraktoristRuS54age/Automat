...
# Представление узлов синтаксического дерева регулярного выражения
class RegexNode:
...
# Состояние автомата с переходами по символам и эпсилон-переходами (пустыми)
class State:
    def __init__(self):
...
# Представление НКА (начальное и конечное состояние)
class NFA:
...
# Парсим строку регулярного выражения в синтаксическое дерево
...
# рекурсивно строим НКА из синтаксического дерева
...
# Преобразуем НКА в удобный для обработки формат (словарь состояний)
