...
# Вычисляем пустые (epsilon) замыкания для каждого состояния
...
# Находим все состояния, достижимые из заданных через пустых (epsilon) - переходы
...
# Строим ДКА с методом подмножеств
...
# Приводим ДКА к стандартному формату 
